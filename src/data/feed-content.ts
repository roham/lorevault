...
export const FEED_CONTENT: FeedEntry[] = [
  ...
  {
    id: 'asgard-drop',
    slug: 'asgard-unleashed-now-live',
    type: 'drop',
    title: 'Asgard Unleashed: Now Live',
    subtitle: '20 Norse gods and monsters enter the vault',
    body: `The Nine Realms have opened. Asgard Unleashed brings 20 characters from Norse mythology — from the All-Father himself to the fire giant who ends it all.\n\nThe chase cards: Odin "The All-Father on Hlidskjalf" legendary and Surtr "The World-Ender" legendary. Odin commands the highest base stats of any card in LoreVault. Surtr has the most dramatic art in the collection — a fire giant engulfing Asgard at Ragnarok.\n\nThe sleeper: Huginn & Muninn "Eyes of the All-Father" rare. The only dual-character card in the set, and it completes three thematic collections (Ravens, Odin's Court, Intelligence).\n\nFenrir, Jormungandr, and Hel form the "Children of Loki" trio — collect all three for a 200 XP completion bonus. Loki himself has the set's most complex card: "The Trickster's Gambit" shifts between three visual states based on your parallel.\n\nThis is the deepest mythological set we've built. Every card quotes directly from the Prose Edda or Poetic Edda.`,
    gradientFrom: '#0a1a2e',
    gradientTo: '#1b3a5c',
    icon: '❄️',
    ctaLabel: 'View Set',
