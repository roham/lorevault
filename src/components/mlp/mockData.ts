...
export const MOCK_SET_PROGRESS: SetProgress[] = [
  {
    ...
    total: 12,
    missingCards: [
      { id: 'lud-003', name: 'The Cobbler\'s Shop', floorPrice: 24 },
      { id: 'lud-004', name: 'The Mayor\'s Wife', floorPrice: 31 },
      { id: 'lud-005', name: 'The Orchard Wall', floorPrice: 18 },
      { id: 'lud-006', name: 'The Shut Customs House', floorPrice: 47 },
      { id: 'lud-007', name: 'A Page Numbered 47-and-a-Half', floorPrice: 88 },
  ...
  },
  {
    ...
    total: 10,
    missingCards: [
      { id: 'oop-003', name: 'The Bishop\'s November Letter', floorPrice: 19 },
  ...
  },
  {
    ...
    total: 11,
    missingCards: [
      { id: 'sinter-002', name: 'The Saint Himself', floorPrice: 56 },
      { id: 'sinter-003', name: 'A Letter Unanswered', floorPrice: 14 },
      { id: 'sinter-004', name: 'The Sack', floorPrice: 32 },
      { id: 'sinter-005', name: 'The Rod', floorPrice: 21 },
      { id: 'sinter-006', name: 'The Crook of the Same Tree', floorPrice: 68 },
      { id: 'sinter-007', name: 'The Swept Threshold', floorPrice: 17 },
...
export const MOCK_PROFILE: CollectorProfile = {
  ...
  paneMastery: [
    ...
    { pane: PANES['old-ones-persist'], owned: 1, total: 10 },
    { pane: PANES['sinterklaas-reigns'], owned: 0, total: 11 },
  ],
